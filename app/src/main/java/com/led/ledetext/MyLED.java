...
public class MyLED extends SurfaceView implements SurfaceHolder.Callback, Runnable {
    ...
    public MyLED(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MyLED(Context context, AttributeSet attrs, int defStyle) {
    ...
    private Bitmap drawText() {
        ...
        canvas.drawText(txt,0,200, paint);
